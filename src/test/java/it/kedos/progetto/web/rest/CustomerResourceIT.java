package it.kedos.progetto.web.rest;

import static it.kedos.progetto.domain.CustomerAsserts.*;
import static it.kedos.progetto.web.rest.TestUtil.createUpdateProxyForBean;
...
import it.kedos.progetto.IntegrationTest;
import it.kedos.progetto.domain.Customer;
import it.kedos.progetto.repository.CustomerRepository;
...
class CustomerResourceIT {
    ...
    void partialUpdateCustomerWithPatch() throws Exception {
        ...
        partialUpdatedCustomer.lastName(UPDATED_LAST_NAME).phoneNumber(UPDATED_PHONE_NUMBER);
