...
import static it.kedos.progetto.domain.OrderAsserts.*;
import static it.kedos.progetto.web.rest.TestUtil.createUpdateProxyForBean;
import static it.kedos.progetto.web.rest.TestUtil.sameNumber;
...
class OrderResourceIT {
    ...
    public static Order createEntity() {
        return new Order().orderDate(DEFAULT_ORDER_DATE).totalAmount(DEFAULT_TOTAL_AMOUNT);
    }
    ...
    public static Order createUpdatedEntity() {
        return new Order().orderDate(UPDATED_ORDER_DATE).totalAmount(UPDATED_TOTAL_AMOUNT);
    }
    ...
    void putExistingOrder() throws Exception {
        ...
        updatedOrder.orderDate(UPDATED_ORDER_DATE).totalAmount(UPDATED_TOTAL_AMOUNT);
