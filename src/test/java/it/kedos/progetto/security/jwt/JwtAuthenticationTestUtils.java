package it.kedos.progetto.security.jwt;

import static it.kedos.progetto.security.AuthoritiesConstants.ADMIN;
import static it.kedos.progetto.security.SecurityUtils.AUTHORITIES_CLAIM;
import static it.kedos.progetto.security.SecurityUtils.JWT_ALGORITHM;
