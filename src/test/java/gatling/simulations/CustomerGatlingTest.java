        ...
        .on(
            exec(
                http("Get all customers")
                    .get("/services/provaprogetto/api/customers")
                ...
                .exec(
                    http("Create new customer")
                        .post("/services/provaprogetto/api/customers")
                        .headers(headersHttpAuthenticated)
                        .body(
                            StringBody(
                                "{" +
                ...
                .on(
                    exec(
                        http("Get created customer").get("/services/provaprogetto${new_customer_url}").headers(headersHttpAuthenticated)
                    ).pause(10)
                )
                .exec(
                    http("Delete created customer").delete("/services/provaprogetto${new_customer_url}").headers(headersHttpAuthenticated)
                )
                .pause(10)
        );
